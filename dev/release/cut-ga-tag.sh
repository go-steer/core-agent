...
#
# --check compares RATES only, ignoring the UpdatedAt stamps the
# generator rewrites on every run, and writes nothing. See the same
# guard in cut-dev-tag.sh — both scripts should reject the same drift.
