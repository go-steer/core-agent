...
## [Interactive]({{< relref "cli/interactive/_index.md" >}})
...
Start with the [interactive quickstart]({{< relref "cli/interactive/quickstart.md" >}}) for the first-15-minutes path.

## [Autonomous]({{< relref "cli/autonomous/_index.md" >}})
...
Start with the [autonomous quickstart]({{< relref "cli/autonomous/quickstart.md" >}}) for the first-15-minutes path.

---

## Library users

If you're embedding `core-agent` inside your own Go binary — building a coding assistant, web service, or custom autonomous worker — see [Using the library]({{< relref "library/_index.md" >}}) instead. The CLI guides above describe how the bundled binary behaves; the library guide covers the Go API you'd use to construct your own.
