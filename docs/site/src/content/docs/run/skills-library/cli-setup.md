...
| To read the patterns yourself first | [Agent design](/agent-design/) (prescriptive) + [Reference](/reference/) (schemas) |
| The 15-minute first-time walkthrough | [Interactive quickstart](/run/interactive/quickstart/) |

The skill IS the docs in workflow form. Pick the surface that matches your read intent.

## Installing

See [Skills library → Installing](/run/skills-library/).
...
- **[Interactive quickstart](/run/interactive/quickstart/)** — the static-docs version of the same walkthrough
- **[System instructions](/agent-design/system-instructions/)** — the prescriptive content the skill's `agents-md-patterns.md` reference is built from
- **[Reference → Skills](/concepts/skills/)** — `SKILL.md` schema, discovery, allow/deny lists
