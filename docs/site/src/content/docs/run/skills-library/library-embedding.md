...
| Reference for every option function + public type | [Library API](/embed/api/) |
| Narrative tour of extension points | [Library guide](/embed/guide/) |
| Quickstart for the first 15 minutes | [Library quickstart](/embed/) (in progress) |
...
- **[Library quickstart](/embed/)** — 15-minute hello-world (in progress)
- **[Library guide](/embed/guide/)** — narrative tour of the extension points
- **[Library API](/embed/api/)** — exhaustive type + option reference
- **[Agent design](/agent-design/)** — prescriptive patterns that apply equally to embedded use
