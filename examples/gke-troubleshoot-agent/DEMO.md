...
# `lookout watch`).
#
# Watcher floor is v0.17.0, and the recipe pins v0.25.0. Two separate
...
crane digest "ghcr.io/go-steer/lookout:v0.25.0" >/dev/null 2>&1 \
    && echo "✓ ghcr.io/go-steer/lookout:v0.25.0 exists" \
    || echo "✗ ghcr.io/go-steer/lookout:v0.25.0 NOT found — check the k8s-lookout release"
```
