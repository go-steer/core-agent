...
// cache), operator-visible formatters, and pricing operations.
// Flag parsing and run() orchestration stay in the binary.
// Multi-session construction and grant persistence arrive in
// later PRs of the same extraction.
package compose
